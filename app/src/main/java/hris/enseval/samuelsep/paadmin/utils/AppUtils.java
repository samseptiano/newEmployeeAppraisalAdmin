...
public class AppUtils {
     ...
     * @param pdfRootAdapter
     * @return
     */
    public static Bitmap findViewBitmap(final List<SKModel> currentPDFModels, int deviceWidth, int deviceHeight, SKAdapter pdfRootAdapter, RecyclerView mPDFCreationRV, View mPDFCreationView) {
